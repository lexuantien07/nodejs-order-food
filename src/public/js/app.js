...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (item) {
      return "\n                <p>".concat(item.item.name, " - ").concat(item.quantity, " ph\u1EA7n </p>\n            ");
    }).join('');
  }
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin */ "./src/resources/js/admin.js");
...
function updateStatus(order) {
  status.forEach(function (stt) {
    stt.classList.remove('step-completed');
    stt.classList.remove('current');
  });
  var completed = true;
  status.forEach(function (stt) {
    var dataStatus = stt.dataset.status;
    if (completed) {
      stt.classList.add('step-completed');
    }
    if (dataStatus === order.status) {
      completed = false;
      small.innerText = moment__WEBPACK_IMPORTED_MODULE_0___default()(order.updatedAd).format('hh:mm A');
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.updatedAd = moment__WEBPACK_IMPORTED_MODULE_0___default()().format();
